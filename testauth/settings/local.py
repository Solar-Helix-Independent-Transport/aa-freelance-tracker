...
# Run Celery tasks (including chains) synchronously and in-process, with no
# broker required, so tests calling tasks that dispatch to Celery can observe
# their effects directly.
